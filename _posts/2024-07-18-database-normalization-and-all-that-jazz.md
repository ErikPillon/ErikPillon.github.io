---
title: Database Normalization Forms and all that Jazz
layout: post
post-image: ../assets/images/db_abstract.png
description: Personal introduction to RDBMS Normalization Forms with a taste of Formula 1 
tags: 
- article
- post
- review
...
![Database Normalization Forms Hierarchy](../assets/images/db_nf_list.png)
...
![First Normalization Form and its failure](../assets/images/driver_table_2.png)
...
![Also in the first table we fail to adhere to the First Normalization Form. The second table fix this issue](../assets/images/driver_table_1.png)
...
![](../assets/images/driver_ranking_table_2.png)
...
![Third Normal Form and its failure on the last column. No transitive dependency is allowed.](../assets/images/3NF_1.png)
...
![Schema comparison between a non-3rd-form normalized table and its improvement.](../assets/images/3NF.png)
...
- [This](https://www.youtube.com/watch?v=GFQaEYEc8_8) beautiful YouTube video introduces all the normalization forms.